!*****************************************************************************
!                Time-stamp: <2009-02-15 15:01:31 sander>
!*****************************************************************************
!OPTION! -O nomove
MODULE messy_jval
  ...
  TYPE(PTR_3D_ARRAY), PUBLIC, DIMENSION(:), POINTER, SAVE  :: jval_gp

  ! heating rates
  REAL, PUBLIC, DIMENSION(:,:,:), POINTER :: rh_o2_3d, rh_o3_3d
  ! mz_pj_20071127+
  REAL, PUBLIC, DIMENSION(:,:,:), POINTER :: fhuv_3d, fhuvdna_3d
  ! mz_pj_20071127-
  ...
  ! S. Chabrillat and G. Kockarts grl 24, p. 2659-2662
  ! with the corrected values from grl 25 p.79 
  ...
  REAL,    DIMENSION(:,:,:), ALLOCATABLE :: fint, finth ! mz_pj_20071127
...
CONTAINS
  ...
  SUBROUTINE combine_o3_fields(input_O3, press_2d,  &
    ...
    REAL, DIMENSION(:,:), INTENT(IN)  :: input_O3, press_2d
    REAL, DIMENSION(:,:), INTENT(IN)  :: press_h, o3_h, v3_h
    REAL, DIMENSION(:,:), INTENT(OUT) :: o3_2d
    REAL, DIMENSION(:,:), INTENT(OUT) :: v3_2d

    ! for calculation of O3 column:
    INTEGER :: kt0, kt1, j1_0, j2_0, j1_1, j2_1
    REAL :: av3_0, dpre_0, dpre_h_0, aro3_0
    REAL :: av3_1, dpre_1, dpre_h_1, aro3_1
    REAL :: dq1, dp1, dq2, dp2, press0
    INTEGER :: nlev_h, j, jp, jk
    REAL, PARAMETER :: sp = N_A * 1000./(M_air*g) * 1.E-4 ! [part./cm^2 * 1/Pa]
    ...
    jp_loop: DO jp = 1,SIZE(input_O3,1)
      ...
      o3_2d(jp,1) = MAX(0., aro3_0 * dpre_0 + o3_h(jp,j2_0))
      o3_2d(jp,2) = MAX(0., aro3_1 * dpre_1 + o3_h(jp,j2_1))
      ! calculate v3_2d
      v3_2d(jp,1) = MAX(0., av3_0 * dpre_0 + v3_h(jp,j2_0))
      v3_2d(jp,2) = MAX(0., av3_1 * dpre_1 + v3_h(jp,j2_1))
  ...
  SUBROUTINE jvalues(jrow,         &
    ...
    ! (e) initialzation of J-values rates (vinit)
    ...
    REAL, DIMENSION(SIZE(slf_1d),SIZE(temp_2d,2)) :: &
      ...
      dv2,      & ! slant O2 column density           [part./cm^2]
      dv3,      & ! slant O3 column density           [part./cm^2]
    ...
    ALLOCATE(finth(kproma,klev,3:5)) ! mz_pj_20071127
    ...
    IF (l_heating)       rh_o3_3d(:,:,jrow)      = vinit
    IF (l_heating)       rh_o2_3d(:,:,jrow)      = vinit
...
#else
      x1 = a0_1_1_O2(i0(j,k))*dlv2_h + a0_1_2_O2(i0(j,k))
      x2 = a0_2_1_O2(i0(j,k))*dlv2_h + a0_2_2_O2(i0(j,k))
      x3 = a0_3_1_O2(i0(j,k))*dlv2_h + a0_3_2_O2(i0(j,k))
      x4 = v3s_du_h
      sig_top_O2(j,0) = x1 + (x2+x3*x4)*x4
      x1 = 1.
      x2 = c0_1_1_O2(i0(j,k))*dlv2_h+c0_1_2_O2(i0(j,k))
      x3 = c0_2_1_O2(i0(j,k))*dlv2_h+c0_2_2_O2(i0(j,k))
      x4 = tnorm_sr(j,k)
      sig_top_O2(j,0) = sig_top_O2(j,0) * (x1 + (x2+x3*x4)*x4)

      x1 = a0_1_1_o3(i0(j,k))*dlv2_h + a0_1_2_o3(i0(j,k))
      x2 = a0_2_1_o3(i0(j,k))*dlv2_h + a0_2_2_o3(i0(j,k))
      x3 = v3s_du_h
      sig_top_o3(j,0) = x1 + x2 * x3
      x1 = 1.
      x2 = c0_1_1_o3(i0(j,k))*dlv2_h+c0_1_2_o3(i0(j,k))
      x3 = c0_2_1_o3(i0(j,k))*dlv2_h+c0_2_2_o3(i0(j,k))
      x4 = tnorm_sr(j,k)
      sig_top_o3(j,0) = sig_top_o3(j,0) * (x1 + (x2+x3*x4)*x4)

      x1 = ct(1)
      x2 = ct(2)
      x3 = ct(3)
      x4 = (dlv2_h-47.)/47.
      tau_0(j)     = x1 + (x2+x3*x4)*x4
#endif
    ENDDO
    ...
    DO k = 1,klev ! altitude loop
      ...
      DO j  = 1,kproma_day ! longitude loop
        ...
        sig0_o3k = &
          ...
          tnorm_sr(j,k))
#else
        x1 = a0_1_1_O2(i0(j,k))*dlv2(j,k) + a0_1_2_O2(i0(j,k))
        x2 = a0_2_1_O2(i0(j,k))*dlv2(j,k) + a0_2_2_O2(i0(j,k))
        x3 = a0_3_1_O2(i0(j,k))*dlv2(j,k) + a0_3_2_O2(i0(j,k))
        x4 = v3_du1(j,k)
        sig0_O2k = x1 + (x2+x3*x4)*x4
        x1 = 1.
        x2 = c0_1_1_O2(i0(j,k))*dlv2(j,k)+c0_1_2_O2(i0(j,k))
        x3 = c0_2_1_O2(i0(j,k))*dlv2(j,k)+c0_2_2_O2(i0(j,k))
        x4 = tnorm_sr(j,k)
        sig0_O2k = sig0_O2k * (x1 + (x2+x3*x4)*x4)

        x1 = a0_1_1_o3(i0(j,k))*dlv2(j,k) + a0_1_2_o3(i0(j,k))
        x2 = a0_2_1_o3(i0(j,k))*dlv2(j,k) + a0_2_2_o3(i0(j,k))
        x3 = v3_du1(j,k)
        sig0_o3k = x1 + x2*x3
        x1 = 1.
        x2 = c0_1_1_o3(i0(j,k))*dlv2(j,k)+c0_1_2_o3(i0(j,k))
        x3 = c0_2_1_o3(i0(j,k))*dlv2(j,k)+c0_2_2_o3(i0(j,k))
        x4 = tnorm_sr(j,k)
        sig0_o3k = sig0_o3k * (x1 + (x2+x3*x4)*x4)
#endif
        dtau_0     = &
        ...
        x2 = taua1_2(i1(j,k))
        x3 = v3_du1(j,k)
        tau_1 = tau_1 + (x1 + x2*x3) * v2s_m(j,k)
        x1 = taub1_3(i1(j,k))
        x2 = taua1_3(i1(j,k))
        x3 = v3_du1(j,k)
        tau_1 = tau_1 + (x1 + x2*x3) * v2s_m(j,k)**2
    ...
    ! zero for non-ma
    r_m(:,:)  = 0.     ! only for photolysis of CO2, CH4, SF6, and H2O
    r_O2(:,:) = 0.           ! only for photolysis of O2
    ...
    IF (l_heating) THEN
      DO k = 1,klev
        DO j = 1,kproma_day
          ...
          rh_O2_3d(iu0(j),k,jrow) = MAX(vinit, dh_O2(j,k) *fj_corr(j,8)) ! 5
#else
          x1 = a0_1_1_h_O2(i0(j,k))*dlv2(j,k)+a0_1_2_h_O2(i0(j,k))
          x2 = a0_2_1_h_O2(i0(j,k))*dlv2(j,k)+a0_2_2_h_O2(i0(j,k))
          x3 = a0_3_1_h_O2(i0(j,k))*dlv2(j,k)+a0_3_2_h_O2(i0(j,k))
          x4 = v3_du1(j,k)
          sig_h_O2(0) = x1 + (x2+x3*x4)*x4
          x1 = 1.
          x2 = c0_1_1_h_O2(i0(j,k))*dlv2(j,k) + c0_1_2_h_O2(i0(j,k))
          x3 = c0_2_1_h_O2(i0(j,k))*dlv2(j,k) + c0_2_2_h_O2(i0(j,k))
          x4 = tnorm_sr(j,k)
          sig_h_O2(0) = sig_h_O2(0) * (x1 + (x2+x3*x4)*x4)
          ...
          x2 = a1_2_h_O2(i1(j,k))
          x3 = v3_du1(j,k)
          sig_h_O2(1) = sig_h_O2(1) + (x1 + x2*x3) * v2s_m(j,k)
          dh_O2(j,k) = (sig_h_O2(0) * fint(j,k,0) +                &
            sig_h_O2(1) * fint(j,k,1) ) * relo2
#endif
          ! O3
          ...
          rh_o3_3d(iu0(j),k,jrow) = MAX(vinit, dh_o3(j,k) *fj_corr(j,6)) ! 3
#else
          x1 = a0_1_1_h_o3(i0(j,k))*dlv2(j,k) + a0_1_2_h_o3(i0(j,k))
          x2 = a0_2_1_h_o3(i0(j,k))*dlv2(j,k) + a0_2_2_h_o3(i0(j,k))
          x3 = v3_du1(j,k)
          sig_h_o3(0) = x1 + x2*x3
          x1 = 1.
          x2 = c0_1_1_h_o3(i0(j,k))*dlv2(j,k)+ c0_1_2_h_o3(i0(j,k))
          x3 = c0_2_1_h_o3(i0(j,k))*dlv2(j,k)+ c0_2_2_h_o3(i0(j,k))
          x4 = tnorm_sr(j,k)
          sig_h_o3(0) = sig_h_o3(0) * (x1 + (x2+x3*x4)*x4)
          ...
          x2 = a1_2_h_o3(i1(j,k))
          x3 = v3_du1(j,k)
          sig_h_o3(1) = sig_h_o3(1) + (x1 + x2*x3) * v2s_m(j,k)
          dh_o3(j,k)   = (sig_h_o3(0)    * fint(j,k,0) +                 &
                          sig_h_o3(1)    * fint(j,k,1) )*relo3(j,k)*1.e6
#endif
    ...
    CALL jval_cal_uv(jrow)  ! mz_pj_20071127

    CALL jval_cal(jrow) ! mz_rs_20090205
    ...
    DEALLOCATE(fint)
    DEALLOCATE(finth) ! mz_pj_20071127
    DEALLOCATE(fj_corr)
    ...
    SUBROUTINE flux_cal
      ...
      k_loop2: DO k = 0,klev
        j_loop3: DO j = 1,kproma_day
          ...
          facth(j,k,3:5) = facth(j,k,3:5) * ftop(j,3:5) ! mz_pj_20071127
        ENDDO j_loop3
      ENDDO k_loop2
    ...
    SUBROUTINE aero_2d
      ...
      DO k = 1,klev
        ...
        DO j = 1,kproma_day
          ...
          IF (rh_ref(8)<= rhum(j,k)) i_ref(j) = 8
          i_ref(j) = MIN(i_ref(j),7)
        ENDDO
  ...
  SUBROUTINE jval_cal_uv(jrow)
    ...
    DO k = 1,klev
       DO j = 1,kproma_day
          ...
          fhuv_3d(iu0(j),k,jrow)=MAX(0.0,dj)
          fhuvdna_3d(iu0(j),k,jrow)=MAX(0.0,djb)
       ENDDO
    ENDDO
...
#include "messy_jval_jvpp.inc"
  ...
  SUBROUTINE jval_read_nml_ctrl(status, iou)
    ...
    NAMELIST /CTRL/ time_control, c_solc_data, qy_CH3COCH3

    ! initialize
    status = 1 ! error

    time_control%method = 'constant' ! default value
    time_control%const  = 170.0      ! default value
    ...
    WRITE(*,*) HLINE2
    IF (TRIM(time_control%method) /= 'constant') &
      WRITE(*,*) 'SOLAR CYCLE DATA      : ',TRIM(c_solc_data)
    WRITE(*,*) 'METHOD                : ',TRIM(time_control%method)
    SELECT CASE(TRIM(time_control%method))
       CASE('constant')
          WRITE(*,*) 'CONSTANT              :', time_control%const
          IF ( (time_control%const<70.0).OR.(time_control%const>270.0) ) THEN
             WRITE(*,*) 'ERROR: time_control%const !e [70,270] !!!'
             RETURN
          END IF
       CASE('transient')
          WRITE(*,*) 'OFFSET [MONTHS]       :', time_control%i1
          IF (time_control%i0 == 0) THEN
             WRITE(*,*) 'INTERPOLATION         : OFF (', time_control%i0,')'
          ELSE
             WRITE(*,*) 'INTERPOLATION         : ON  (', time_control%i0,')'
          END IF
       CASE('stationary')
          WRITE(*,*) 'MONTH / YEAR          :',  &
               time_control%i1,' / ',time_control%i2
       CASE('cyclic')
          WRITE(*,*) 'START (MONTH / YEAR)  :',  &
               time_control%i1,' / ',time_control%i2
          WRITE(*,*) 'RESET AFTER [MONTHS]  :', time_control%i3
          IF (time_control%i0 == 0) THEN
             WRITE(*,*) 'INTERPOLATION         : OFF (', time_control%i0,')'
          ELSE
             WRITE(*,*) 'INTERPOLATION         : ON  (', time_control%i0,')'
...
! ****************************************************************************
  ...
  SUBROUTINE jval_solar_time_control(status, YEAR, MONTH, DAY, HOUR, cdisse)
    ...
    INTEGER, INTENT(IN)  :: YEAR, MONTH, DAY, HOUR ! current date/time
    REAL,    INTENT(IN)  :: cdisse

    ! LOCAL
    CHARACTER(LEN=*), PARAMETER :: substr = 'jval_solar_time_control'
    REAL(DP), DIMENSION(:), POINTER :: val   => NULL()
    REAL(DP), DIMENSION(:), POINTER :: rflag => NULL()

    CALL get_tseries_data(status, substr, time_control, tseries &
       , YEAR, MONTH, DAY, HOUR, val, rflag)
    IF (status /= 0) RETURN

    status = 1 ! ERROR

    SELECT CASE(tseries%npar)
    CASE(1)
       !
       ! The F10.7cm (in sfu) used here must be adjusted to the Sun-Earth
       ! distance of 1 AU.
       ! In order to obtain the solar signal at the current orbit position,
       ! the factor cdisse is multiplied.
       !
       ! NOTE: expert (chb) guess: r_sol = 0 for 70 sfu ; = 1 for 270 sfu
       ! reference: atlas2 spectrum and wmo86
    ...
    CASE DEFAULT
       !
       WRITE(*,*) substr, ': ERROR IN CHOICE OF '//TRIM(c_solc_data)//&
            &' ! NPAR = ',tseries%npar,' NOT YET IMPLEMENTED'
       RETURN
       !
    END SELECT
    ...
    IF (ASSOCIATED(rflag)) DEALLOCATE(rflag)
    NULLIFY(rflag)
