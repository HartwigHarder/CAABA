...
\note{G4306}{The MCM products are 0.2 IPROPOL + 0.2 \kpp{CH3COCH3} + 0.6
  IC3H7O. IPROPOL and IC3H7O are substituted with their degradation
  products. We assume IPROPOL to be oxidized entirely to \kpp{CH3COCH3}
  + \kpp{HO2} by \kpp{OH}. IC3H7O + \kpp{O2} produces the same
  products.}
...
\note{G4437}{\kpp{LHMVKABO2} is a lumped species of virtual composition
  ...
  the permutation reactions of each single MCM RO2.}
